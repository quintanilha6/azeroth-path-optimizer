...
function Config:CreateMenu()
	...
	UIConfig.ScrollFrame:SetSize(460, 360);
	UIConfig.ScrollFrame:SetPoint("CENTER");
	UIConfig.ScrollFrame:SetClipsChildren(true);

	----------------------------------
	-- Tabs
	----------------------------------
	local tab1content = SetTabs(UIConfig, 2, "Main", "Settings");

	----------------------------------
	-- Buttons
	----------------------------------
	-- Calculate Optimal Path Button:
	tab1content.saveBtn = self:CreateButton("RIGHT", tab1content, "TOP", 0, -50, "Calculate OP");

	-- Reset Button:	
	tab1content.resetBtn = self:CreateButton("CENTER", tab1content.saveBtn, "CENTER", 100, 0, "Reset");
